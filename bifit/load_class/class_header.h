...
#define BIFIT_MAJOR_VERSION_BYTE_OFFSET 4
#define BIFIT_MINOR_VERSION_BYTE_OFFSET 6
...
void load_class_header(const uint8_t data[], bifit_class_header_t *out) {
    ...
    out->minor_version = parse_integer_u2(BIFIT_MAJOR_VERSION_BYTE_OFFSET, data);
    LOG_DEBUG("load_class_header major_version: %d\n", out->minor_version);
    // guess java version
